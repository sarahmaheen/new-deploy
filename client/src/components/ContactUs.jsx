        ...
        const contactMethods = [
            {
                ...
                ,
                contact: "syedmujahidahmed0@gmail.com"
            },
            {
                icon:
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                ...
                <div className="max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8">
                    <div className="max-w-lg mx-auto gap-12 justify-between lg:flex lg:max-w-none">
                        <div className="max-w-lg space-y-3">
                            <h3 className="text-indigo-600 font-semibold" style={{textAlign:'initial'}}>
                                Contact
                            </h3>
                            <p className="text-gray-800 text-3xl font-semibold sm:text-4xl" style={{textAlign:'initial'}}>
                        ...
                        <div className="flex-1 mt-12 sm:max-w-lg lg:max-w-md" style={{textAlign:'initial'}}>
                            <form
                                onSubmit={(e) => e.preventDefault()}
                                className="space-y-5"
                            >
                                <div>
                                    <label className="font-medium" style={{textAlign:'initial'}}>
                                        Full name
                                    </label>
                                    <input
                                        type="text"
